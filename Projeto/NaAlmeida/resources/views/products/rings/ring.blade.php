            ...
            <div class="productSpecification">
                <form action="">
                    <div class="d-flex flex-column px-4 py-2 justify-content-start">
                        <div class="fs-4" style="font-weight:bold;">R$ {{ $ring->value }}.00 av</div>
                        <div class="fs-7 ">R$ {{ ($ring->value)*1.1 }}0 av</div>
                    </div>
                    ...
                    <div class="py-3">
                        <a class="btn text-white btn-lg btn-block w-100" id="btnAddBag" type="button" onclick="loadValueAp()">
                            <div class="d-flex flex-wrap justify-content-center">
