            ...
            <div class="col-md-5 col-lg-4 order-md-last">
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-sm" style="color: #696969;">
                        <div>
                            <h6 class="my-0"><?php echo e(data_get($product,'name')); ?></h6>
                            <small class="text-muted"><?php echo e(data_get($product,'qtd')); ?> unidades</small>
                        </div>
                        <span class="text-muted">R$ <?php echo e(data_get($product,'value_ap')); ?> ap</span>
                    </li>
                    ...
                    <li class="list-group-item d-flex justify-content-between">
                        ...
                        <strong><?php echo e($value_total_ap); ?></strong>
                    </li>
                    <li class="list-group-item d-flex justify-content-between bg-light">
                        ...
                        <span class="text-success">R$ <?php echo e($value_total_av); ?></span>
                    </li>
                ...
                <form class="needs-validation" novalidate="">
                    ...
                    <div class="my-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="credit">Crédito - ( R$ <?php echo e($value_total_ap); ?> )</label>
                        </div>
                        <div class="form-check">
                            <input id="pix" name="paymentMethod" type="radio" class="form-check-input" required="">
                            <label class="form-check-label" for="pix">Pix - ( R$ <?php echo e($value_total_av); ?> )</label>
                        </div>
                    </div>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samsung\Documents\GitHub\2021-02-atividades-naalmeida98\Projeto\NaAlmeida\resources\views/checkout.blade.php ENDPATH**/ ?>