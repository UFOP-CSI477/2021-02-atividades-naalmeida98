...
<div class="container">
    <div class="row row-cols-1 row-cols-lg-2 align-items-stretch py-3">
        <div class="col-sm-8 row row-cols-1">
            <!-- <img src="<?php echo e(asset('images/image04.jpg')); ?>" alt="image03" width="100%">
            ...
            <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('images/image04.jpg')); ?>" alt="image01" class="imagesBook">
                        <div class="container">
                    ...
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/image05.jpg')); ?>" alt="image02" class="imagesBook">
                        <div class="container">
                    ...
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/image03.jpg')); ?>" alt="image03" class="imagesBook">
                        <div class="container">
            ...
            <div class="productSpecification">
                <form action="">
                    <div class="d-flex flex-column px-4 py-2 justify-content-start">
                        <div class="fs-4" style="font-weight:bold;" id="valueAvProduct">R$ <?php echo e($product->value_av); ?>.00 à vista</div>
                        <div class="fs-7" id="valueApProduct">R$ <?php echo e($product->value_ap); ?>0 à prazo</div>
                    </div>
                    ...
                    <div class="px-4">
                        ...
                        <input type="text" name="qtd" id="qtdProduct" value="<?php echo e($product->qtd_cart); ?>" class="inputQTD" >
...
<script src="<?php echo e(asset('js/shopping/shoppingBag.js')); ?>"></script>
<script src="<?php echo e(asset('js/products/product.js')); ?>"></script>
<link href="<?php echo e(asset('css/products/product.css')); ?>" rel="stylesheet">

<?php $__env->stopSection(); ?>

<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samsung\Documents\GitHub\2021-02-atividades-naalmeida98\Projeto\NaAlmeida\resources\views/products/product.blade.php ENDPATH**/ ?>